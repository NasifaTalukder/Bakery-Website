...
import panDi2 from "../../assets/ShopPageImg/pan Di 1.png"
const ShopProdTwel = () => {
  return (
   <>
   <div className='w-[290px] h-[470px] bg-slate-100 rounded-sm'>
     <div className='' >
      <img src={panDi2} alt="" className='' />
      </div>
      <div className='ml-20 mt-[-25px]'>
      <h1 className='FP1 text-base font-semibold tracking-wider'>Croissant Breads</h1>
