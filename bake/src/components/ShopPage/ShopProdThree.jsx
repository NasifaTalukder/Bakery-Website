...
import Bread2 from "../../assets/ShopPageImg/Olive Pic Two.png"
...
const ShopProdThree = () => {
  return (
   ...
   <div className='w-[290px] h-[470px] bg-slate-100 rounded-sm'>
     <div className='' >
      <img src={Bread2 } alt="" className='' />
      </div>
      <div className='ml-20 mt-[-25px]'>
      <h1 className='FP1 text-base font-semibold tracking-wider'>Borodinsky Breads</h1>
      <div className='flex flex-wrap space-x-3 font-semibold '>
        <p className='text-[#BB9230]'><del>$19.50</del></p>
        <p className=''>$14.00</p>
      </div>
      </div>
      <div>
