...
import Cokkie  from "../../assets/ShopPageImg/Cokkie.png"
...
const ShopProdFive = () => {
  return (
   ...
   <div className='w-[290px] h-[470px] bg-slate-100 rounded-sm'>
     <div className='' >
      <img src={ Cokkie  } alt="" className='' />
      </div>
      <div className='ml-20 mt-[-25px]'>
      <h1 className='FP1 text-base font-semibold tracking-wider'>Chocolate Cookies</h1>
