...
import WhiteCokkie from "../../assets/ShopPageImg/WhiteCokkie.png"
const ShopProdEleven = () => {
  return (
    <>
    <div className='w-[290px] h-[470px] bg-slate-100 rounded-sm'>
     <div className='' >
      <img src={WhiteCokkie} alt="" className='' />
      </div>
      <div className='ml-20 mt-[-25px]'>
      <h1 className='FP1 text-base font-semibold tracking-wider'>Anadaman Cookies</h1>
