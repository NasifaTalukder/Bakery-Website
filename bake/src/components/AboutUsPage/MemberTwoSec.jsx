...
import memberTwo from "../../assets/AboutUspageImg/mem-02.png"
const MemberTwoSec = () => {
  return (
   <>
   
   <div className='w-[370px]'>
          <img src={memberTwo} alt="" className='w-[370px]'/>
          <h1 className='memH text-xl font-semibold text-center mt-4'>Jane Doe</h1>
           <p className='text-[#878787] font-medium text-center mt-1'>Director</p>
