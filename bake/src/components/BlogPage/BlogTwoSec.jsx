...
import BlogImgTwo from "../../assets/BlogPageImg/BlogImg2.png"
const BlogTwoSec = () => {
  return (
    <>
     <div className='w-[380px]'>
         <img src={BlogImgTwo} alt="" className='w-[380px]'/>
         <h1 className='blogHeadH text-[18px] font-medium text-center mt-5 hover:text-[#BB9230]'>Brownie Bread & Cookie</h1>
