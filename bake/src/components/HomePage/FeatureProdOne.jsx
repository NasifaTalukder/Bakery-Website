...
import OliveImg from "../../assets/HomepageImg/Olive Pic One.png"
import SearchIcon from '@mui/icons-material/Search';
import FavoriteBorderIcon from '@mui/icons-material/FavoriteBorder';
const FeatureProdOne = () => {
  return (
    <>
     <div className='w-[290px] h-[470px] bg-slate-100 rounded-sm'>
     <div className='' >
      <img src={OliveImg} alt="" className='' />
      </div>
      <div className='ml-20 mt-[-25px]'>
      <h1 className='FP1 text-base font-semibold tracking-wider'>Olive Ciabatta</h1>
      <div className='flex flex-wrap space-x-3 font-semibold '>
        <p className='text-[#BB9230]'><del>$28.00</del></p>
        <p className=''>$22.00</p>
      </div>
      </div>
      <div>
